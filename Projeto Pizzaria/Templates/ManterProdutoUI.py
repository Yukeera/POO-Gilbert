...
class ManterProdutoUI:
    ...
    def inserir():
        ...
        if st.button("Cadastrar"):
            try:
                View.produto_inserir(nome, descricao, preco, estoque, cat.getId())
    ...
    def atualizar():
        ...
        novo_nome = st.text_input("Informe o novo nome:", op.getNome())
        ...
        if st.button("Atualizar"):
            try:
                View.produto_atualizar(op.getId(), novo_nome, nova_desc, novo_preco, novo_estoque, nova_cat.getId())
